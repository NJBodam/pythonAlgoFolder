...
for key, value in nominated.items():
    for director in value:
        if director not in count_of_directors:
            count_of_directors[director] = 1
        else:
            count_of_directors[director] += 1
...
for key, value in winners.items():
    for director in value:
        if director not in count_of_winners:
            count_of_winners[director] = 1
        else:
            count_of_winners[director] += 1

print(count_of_winners)
...
for key, value in winners.items():
    for director in value:
        if director not in win_count_dict:
            ...
            win_count_dict[director] += 1
            if win_count_dict[director] > max:
                max = win_count_dict[director]
    

most_win_director = [key for key, value in win_count_dict.items() if value >= max]
